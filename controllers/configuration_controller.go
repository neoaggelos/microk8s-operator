...
//+kubebuilder:rbac:groups=microk8s.canonical.com,resources=configurations,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=microk8s.canonical.com,resources=configurations/status,verbs=get;update;patch
